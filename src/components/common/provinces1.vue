...
<template>
  ...
  <div class="formItem">
    ...
    <div class="formItem">
      ...
      <el-select v-model="searchForm.cityCode" placeholder="--请选择县--" filterable :disabled="true">
    ...
    <div class="formItem">
      <el-select
        ...
        @change="changeTown"
        filterable
        :disabled="disableSelectTown||disableselect"
      >
    ...
    <div class="formItem">
      <el-select
        ...
        filterable
        :disabled="disableSelectVillage||disableselect"
      >
        <el-option
...
export default {
  ...
  created() {
    ...
    // if (JSON.stringify(this.provinces)=='{}'||this.provinces==undefined) {
    //   console.log("添1")
    //   this.getAreaListData();
    // } else {
    //    this.getAreaListData1();
  ...
  methods: {
    ...
    async getAreaListData() {
      ...
      if (sessionAreaCode.length > 0) {
        ...
        // _this.searchForm.townCode = sessionTownCode;
        // _this.searchForm.villageCode = sessionVillageCode;
        // this.searchForm.cityName = sessionAdminInfo.areaName;
        // this.searchForm.townName = sessionAdminInfo.streetName;
        // this.searchForm.villageName = sessionAdminInfo.villageName;
      }
    },
