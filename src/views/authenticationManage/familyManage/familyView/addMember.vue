    ...
    <el-form ref="editForm" :model="editForm" :rules="editRules" label-width="120px">
      ...
      <div class="floatLeft">
        ...
        <el-form-item label="民族：" prop="national" class="formItems">
          <el-select v-model="editForm.national" placeholder="请选择"  :disabled="memberId!=''" clearable filterable>
            <el-option
      ...
      <div class="floatLeft">
        <el-form-item label="身份证号：" prop="identity" class="formItems">
          <el-input v-model="editForm.identity" placeholder="身份证号" minlength="0" maxlength="18"  :disabled="memberId!=''"></el-input>
        </el-form-item>
      ...
      <div class>
        <!-- is-required -->
        <el-form-item label="区域选择：" class="provincess" prop="villageCode" required>
          <el-input v-show="false" type="text" v-model="editForm.villageCode" placeholder></el-input>
          <!-- <provinces @changeTown="changeTown" :provinces="provincesobj" :disableselect="true"></provinces> -->
            <provinces @changeTown="changeTown" :disableselect="true" :provinces="provincesobj" v-if="memberId&&isprovincesobj"></provinces>
                  <provinces @changeTown="changeTown" v-if="!memberId" :isadd="provincesobj1" :disableselect="true"></provinces>
        </el-form-item>
      </div>
      <div class="floatLeft">
        ...
        <!-- <el-form-item label="门牌号：" prop="houseNumber" class="formItems">
          <el-input v-model="editForm.houseNumber" placeholder="门牌号" disabled="disabled"></el-input>
        </el-form-item> -->
         <el-form-item label="门牌号：" prop="doorNum" class="formItems">
           <el-select v-model="editForm.doorNum" placeholder="请选择门牌号"  disabled="disabled">
            <el-option
 ...
 this.deptLevel = this.adminUserInfo.deptLevel;
  if (!this.$route.query.memberId) {
    ...
    if (this.$route.query.memberId) {
      ...
      this.memberDetails();
       this.$route.meta.title = "编辑家庭成员";
    }else{
         this.$route.meta.title = "添加家庭成员";
    }
  ...
  methods: {
    ...
    async getListData() {
      ...
      if (res.status === "success") {
        ...
        this.editForm.doorNum = res.data.doorNum;
        this.editForm.groupCode = res.data.groupCode;
        this.editForm.groupName = res.data.groupName;
