  ...
  <div class>
    <el-form :inline="true" :model="searchForm" class="demo-form-inline">
      ...
      <el-form-item label="政策主题：">
        <el-input v-model="searchForm.policyName" placeholder="政策主题"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table border v-loading="loading" :data="tableListData" style="width: 100%">
      ...
      <el-table-column prop="title" label="政策主题" width="300px" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getListData() {
      ...
      const res = await this.$http.policyCheckList({
        ...objcommon,
        ...this.obj
      });
