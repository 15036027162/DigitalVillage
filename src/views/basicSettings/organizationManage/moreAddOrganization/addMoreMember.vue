    ...
    <div>
        <el-form :model="memberEdit" label-width="100px"  :rules="rulesEdit" ref="memberEdit">
            ...
            <el-form-item label="部门名称：" required>
                <el-select v-model="memberEdit.organization" placeholder="--请选择--" disabled>
...
<script>
    export default {
        ...
        mounted() {
            /*this.getUserRole()*/
            let session_adminInfo = JSON.parse(this.$getStore('subMember')) || '';
            ...
            */
            async getJob(){
                ...
                if(res.status==='success'){
                    ...
                    this.memberEdit.organization =session_adminInfo.id
                }
            },
            ...
            async submitForm(){
                ...
                if(this.getUser.memberId){
                    ...
                    /*if(2<=this.memberChange.post.length<=12&&this.memberEdit.mobile&&this.memberEdit.type){
